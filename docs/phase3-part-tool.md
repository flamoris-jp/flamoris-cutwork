...
- In `FittingPreview`, ordinary wheel up moves inward and wheel down restores
  outward toward the rough fence.
...
4. Confirm wheel up contracts inward and wheel down exactly restores outward.
